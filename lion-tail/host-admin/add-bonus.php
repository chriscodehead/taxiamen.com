...
if (isset($_POST['post'])) {
	...
	$demo_balance = mysqli_real_escape_string($link, $_POST['demo_balance']);
	if (!empty($bonus)) {

		$amount = $bonus;
		$fields = array('main_account_balance', 'demo_balance');
		$values = array($amount, $demo_balance);
						...
						<form action="" method="post" enctype="multipart/form-data">
							<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								<tbody>
									...
									<tr>
										<td>
											...
											<div class="form-group">
												...
												<hr color="red">
												<div class="col-lg-6">
													Available Live Balance($): <input type="number" value="<?php print @$cal->selectFrmDB($user_tb, 'main_account_balance', 'email', $user_id); ?>" class="form-control" id="bonus" name="bonus" placeholder="0.00">
												</div>
											</div>
										</td>
									...
									<tr>
										<td>
											...
											<div class="form-group">
												<hr color="red">
												<div class="col-lg-6">
													Available Demo Balance($): <input type="number" value="<?php print @$cal->selectFrmDB($user_tb, 'demo_balance', 'email', $user_id); ?>" class="form-control" id="demo_balance" name="demo_balance" placeholder="0.00">
												</div>
											</div>
										</td>
									...
									<tr>
										<td align="right">
											<input class="btn btn-primary" type="submit" name="post" value="Update Bonus" />
										</td>
									</tr>
								</tbody>
							</table>
															...
															<td>
																<?php if ($row['deposit_status'] == 'confirmed') { ?>
																	...
																	<?php } else { ?>
																		...
																		<?php } ?>
																		<?php print $row['deposit_status']; ?></span>
															</td>
															<td><i class="fa fa-plus complete normal"></i>

																<?php if ($row['coin_type'] == 'perfectmoney' || $row['coin_type'] == 'ETH') {
																	print '$' . $row['amount'];
																} else {
																	print $row['amount'];
																} ?>
