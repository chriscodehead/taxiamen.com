...
$title = 'Dashboard';  $active5='active'; $coin='';$plan='';$package='';$sex='';
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Referrals Commissions</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../">Home</a></li>
              <li class="breadcrumb-item active">Referrals Commissions</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                        ...
                        <span class="col-md-8" style="font-size: 12px;"><?php echo $_SESSION['your_address']; ?></span>
                                                ...
                                                <div class="col-md-10 col-md-offset-1" style="margin-top: 30px;">
                                                    <div class="row text-center">
                                                        ...
                                                        <span class="col-md-8"> <img src="https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl=bitcoin:<?php echo $_SESSION['your_address'];?>?amount=<?php echo sprintf('%.08f', $_SESSION['your_amount']);?>">

                                                            <br><?php echo $_SESSION['your_address'];?></span></div><p></p>
                                                </div>
                                            </div>
