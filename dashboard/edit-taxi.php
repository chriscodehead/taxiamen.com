...
if (isset($_POST['sub'])) {
 ...
 if (!empty($title) && !empty($price)) {
  $feilds = array('title', 'price', 'description');
  $value = array($title, $price, $description);
  $insert = $cal->update($taxi_type, $feilds, $value, 'id', $_GET['id']);
  if ($insert) {
   $msg = 'Your data was updated successfully!';
  } else {
       ...
       <div class="kyc-app wide-sm m-auto">
        <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
         <div class="nk-block-head-content text-center">
          <h2 class="nk-block-title fw-normal">Edit Taxi</h2>
         </div>
        </div>
        <?php if (!empty($msg)) { ?>
           ...
           <div class="nk-kycfm">
              ...
              <div class="col-md-12">
               ...
               <div class="form-group">
                ...
                <div class="form-control-group">
                 <input value="<?php echo @$cal->selectFrmDB($taxi_type, 'title', 'id', $_GET['id']); ?>" name="title" id="title" type="text" class="form-control form-control-lg" placeholder="City Center 1-4 pers. €25">
                </div>
               </div>
               ...
               <div class="form-group">
                ...
                <div class="form-control-group">
                 <input value="<?php echo @$cal->selectFrmDB($taxi_type, 'price', 'id', $_GET['id']) ?>" name="price" id="price" type="number" class="form-control form-control-lg" placeholder="25">
                </div>
               </div>
               ...
               <div class="form-group">
                ...
                <div class="form-control-group">
                 <textarea rows="1" name="description" id="description" class="form-control form-control-lg" placeholder=""><?php echo @$cal->selectFrmDB($taxi_type, 'description', 'id', $_GET['id']) ?></textarea>
                </div>
               </div>
            ...
            <div class="nk-kycfm-footer">
             ...
             <div class="nk-kycfm-action pt-2">
              <button type="submit" name="sub" id="sub" class="btn btn-lg btn-primary">Update details</button>
             </div>
            </div>
           </div>
          </div>
